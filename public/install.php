...
<div class="container">
    ...
    <?php elseif ($step == 3): ?>
        ...
        <?php else: ?>
            ...
            mysqli_close($link);
            ?>
            <div class="alert alert-success"><strong>数据已经导入!</strong>安装已经成功!&#20159;&#30721;&#37239;&#31449;&#28304;&#30721;&#32593;</div>
            <?php sleep(2); ?>
...
");
    ...
    <?php else: ?>
        ...
        <div class="alert alert-success"><strong>已经安装成功,&#20159;&#30721;&#37239;&#31449;&#28304;&#30721;&#32593;</strong></div>
...
<footer class="footer">
    <div class="container">
        <p class="text-muted">©2022 AI在线客服系统 | 本产品禁止用于含木马、病毒、色情、赌博、诈骗等违法违规业务 | &#20159;&#30721;&#37239;&#31449;&#28304;&#30721;&#32593;</p>
    </div>
</footer>
<!-- javascript -->
